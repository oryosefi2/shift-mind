      ...
      <div className="flex">
        ...
        {(isDesktop || isSidebarOpen) && (
          <div
            ...
            } w-80 h-screen bg-white shadow-lg border-l border-gray-200/60 overflow-y-auto transition-all duration-300 ease-in-out ${
              isDesktop || isSidebarOpen ? 'translate-x-0 opacity-100' : '-translate-x-full opacity-0'
            }`}
          >
              {/* Sidebar Header */}
